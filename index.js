...
const totalRaisedThisSection = GAMES_JSON.reduce((acc, game) => acc + game.pledged, 0);

// create a string that explains the number of unfunded games using the ternary operator
const descriptionText = `A total of $${totalRaisedThisSection.toLocaleString()} has been raised across ${GAMES_JSON.length} games. ${numUnfundedGames} game${numUnfundedGames === 1 ? " remains" : "s remain"} unfunded.`;
...
const [mostFundedGame, secondMostFundadedGame] = sortedGames;

// create a new element to hold the name of the top pledge game, then append it to the correct element
const firstGameElement = document.createElement("p");
firstGameElement.innerText = mostFundedGame.name;
firstGameContainer.appendChild(firstGameElement);
// do the same for the runner up item
const secondGameElement = document.createElement("p");
secondGameElement.innerText = secondMostFundadedGame.name;
